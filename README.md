...
int main() {
  char msg[] = "DEETCHANA", enc[100], dec[100];
  hill(msg, enc, 1); printf("Encrypted: %s\n", enc);
  hill(enc, dec, 0); printf("Decrypted: %s\n", dec);
}
```
## OUTPUT
<img width="1686" height="900" alt="image" src="https://github.com/user-attachments/assets/e4db9ca3-b3c9-4116-88e4-33abe3708310" />
